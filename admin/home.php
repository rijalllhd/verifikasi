...
<head>
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="img/logo_pijaralam.png" alt="pijaralam" height="60" width="60">
  </div>
</head>
  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../admin/_datasiswa/datasiswa.php" class="nav-link">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class=" container-fluid">
          <div class="row">
            <h1>Selamat Datang, Admin <?php echo $fetch['Nama'] ?>!</h1>
    ...
    <footer class="main-footer">
      <strong>Yayasan Pijar Alam Indonesia 2024.</strong>
